...
% the complete piece this time (the earlier fur-elise work in this
% directory only used the first ~60 seconds). Sustain pedal markings from
% the original are dropped for eroica's rendering, same as before.
